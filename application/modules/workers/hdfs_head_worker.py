...
#    try:
	...
	print url,headlist,"urllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll"

        headers = {'content-type': 'application/json', 'Accept': 'text/plain'}
	head_data = {"output":headlist,"request_id":str(request_id)}
	print type(head_data),"dataaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
